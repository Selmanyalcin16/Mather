        ...
        <View style={styles.StatBoxes}>
          ...
          >
            <View style={styles.StatBox}>
              <Text style={styles.Numbers}>{this.state.Game}</Text>
              <Text style={styles.StatText}>Games Played</Text>
            </View>
            <View style={styles.StatBox}>
              <Text style={styles.Numbers}>{this.state.Win}</Text>
          ...
          >
            <View style={styles.StatBox}>
              <Text style={styles.Numbers}>{this.state.Lost}</Text>
              <Text style={styles.StatText}>Games Lost</Text>
            </View>
            <View style={styles.StatBox}>
              <Text style={styles.Numbers}>{this.state.Cup}</Text>
